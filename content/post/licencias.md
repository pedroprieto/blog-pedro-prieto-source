...
> El derecho de autor es un conjunto de normas jurídicas y principios que afirman los derechos morales y patrimoniales que la ley concede a los autores (los derechos de autor), por el simple hecho de la creación de una obra literaria, artística, musical, científica o didáctica, esté publicada o inédita.  --Fuente: [Wikipedia](https://es.wikipedia.org/wiki/Derecho_de_autor)

{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Copyright.svg/240px-Copyright.svg.png" caption="<span class=\"figure-number\">Figure 1: </span>Símbolo del Copyright" >}}
...
Para más información se puede consultar el [artículo de la Wikipedia sobre derechos de autor](https://es.wikipedia.org/wiki/Derecho_de_autor).
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Copyleft.svg/240px-Copyleft.svg.png" caption="<span class=\"figure-number\">Figure 2: </span>Símbolo del Copyleft" >}}

La primera licencia de este tipo fue la [GNU General Public License](https://es.wikipedia.org/wiki/GNU_General_Public_License), creada por [Richard Stallman](https://es.wikipedia.org/wiki/Richard_Stallman).
...
-   [MIT License](https://es.wikipedia.org/wiki/Licencia_MIT) - Es la licencia más sencilla y permisiva de todas. Simplemente exige que se muestre la licencia y el reconocimiento de la autoría.
-   [GNU GPL](https://es.wikipedia.org/wiki/GNU_General_Public_License) - Existen varias versiones de esta licencia, actualmente la versión 3. Exige que las modificaciones sobre el código **se redistribuyan con la misma licencia**.
-   [Apache License](https://es.wikipedia.org/wiki/Apache_License) - Licencia que permite que los trabajos derivados se distribuyan bajo una licencia distinta.
-   [Mozilla Public License](https://es.wikipedia.org/wiki/Mozilla_Public_License) - Licencia permisiva que permite que los trabajos derivados se distribuyan bajo una licencia distinta.
...
Este tipo de licencias se suelen utilizar para proyectos tales como contenidos (blogs, sitios web,...), imágenes, vídeos,... Las más utilizadas son las licencias [Creative Commons](https://creativecommons.org/licenses/?lang=es_ES). Estas licencias permiten la **libre distribución** de la obra con **algunas condiciones**:
...
{{< figure src="/ox-hugo/google_images_copyleft.png" caption="<span class=\"figure-number\">Figure 3: </span>Búsqueda de imágenes por tipo de licencia" >}}
