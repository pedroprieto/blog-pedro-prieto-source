...
**** Software
Edición, conversión, animaciones
...
*** Animaciones :animaciones:
    :PROPERTIES:
    :EXPORT_FILE_NAME: animaciones_web
    :END:

*** Audio en la web :audio:
    :PROPERTIES:
    :EXPORT_FILE_NAME: audio_web
    :END:
...
Etiquetas, audio vs música de fondo

*** Vídeo en la web :video:
    :PROPERTIES:
    :EXPORT_FILE_NAME: video_web
    :END:
